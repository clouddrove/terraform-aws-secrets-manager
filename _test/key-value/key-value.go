...
// Description : This Terratest is used to test the Terraform Secrets Manager module.
...
func Test(t *testing.T) {
	...
	terraformOptions := &terraform.Options{
		...
		TerraformDir: "../_example/key-value",
	}
	...
	assert.Equal(t, "secrets-manager-test", Tags["Name"])
